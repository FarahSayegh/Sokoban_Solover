# Sokoban Solver – C++ Game Engine with AI Search Algorithms
...
- `Sokoban.h / Sokoban.cpp` – Main class handling game logic and AI integration.
- `Cell`, `Position`, `CellType` – Supporting components for game state and grid layout.
- `CompareCost`, `CompareDistance`, `CompareF` – Custom comparators for search algorithms.
- `main.cpp` – Entry point for launching the game or search algorithm.
